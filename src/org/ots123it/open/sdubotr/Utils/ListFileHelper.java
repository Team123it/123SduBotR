 ...
 * @author 御坂12456
 * @since 0.2.5
 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该类。请改用{@link org.ots123it.jhlper.DBHelper}。
 *
 */
public class ListFileHelper  {
	 ...
	 * 创建一个新的列表文件辅助操作实例。
	 * @param path 列表文件的路径。
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。请改用{@link org.ots123it.jhlper.DBHelper.DBHelper(String)}。
	 */
	 ...
	 * 创建一个新的列表文件辅助操作实例。
	 * @param file 列表文件的对象。
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。请改用{@link org.ots123it.jhlper.DBHelper.DBHelper(File)}。
	 */
	...
	/**
	 * 创建一个空的新列表文件辅助操作实例。
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。
	 */
	 ...
	 * 获取本实例的列表文件对象
	 * @return 列表文件对象
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。请改用{@link org.ots123it.jhlper.DBHelper.getDatabaseFile()}。
	 */
	public File getFile()
	{
		try {
	 ...
	 * 获取本实例的列表文件路径
	 * @return 列表文件路径
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。请改用{@link org.ots123it.jhlper.DBHelper.getDatabasePath()}。
	 */
	 ...
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。请改用{@link org.ots123it.jhlper.DBHelper.executeQuery(String)}。
	 */
	 ...
	 * @deprecated 自0.5.0起不再使用列表文件记录数据，如非必要，不建议使用该方法。请改用{@link org.ots123it.jhlper.DBHelper.executeNonQuerySync(String)}。
	 */
