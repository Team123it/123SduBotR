...
### 3.群增强功能
#### 3-1.群成员日发言榜提醒功能(灵感来源:Sugar 404,更新版本:Alpha 0.1.7)
...
### 4.实用功能
#### 4-1.查看新冠肺炎(SARS-Cov-2)疫情实时数据(更新版本:Alpha 0.2.3)
数据来源：丁香园(丁香医生)<br>
...
**中文兼容指令："疫情" = "!cov"**<br>
#### 4-2.Bilibili相关功能(更新版本:Alpha 0.3.1)
...
### 机器人主人专用功能
#### M-1.查看运行状态功能(灵感来源:孤灯照镜上,更新版本:Alpha 0.0.5)
...
使用方法：<br>
在\group\list\conflictWL.txt中添加要屏蔽的其它机器人的QQ号<br>
